        ...
        <div class="content">
            <div class="title m-b-md justify-content-center">
                ...
                <div class=" container rounded welcome-box" >
                    ...
                    <p class="decription-text text-justify">Since, the requirements in this agile world changes rapidly. looking at the earlier requirements we could have been managed <b>only</b> with the images too. Therefore, I came up with three different approaches. There were two approaches working with images and the <b>third</b> and my prefered <a href="Approach-3">approach</a> for future of the board. I tried to keep my <a href="https://github.com/NavneetaShrivastava/ChessBoard"  target="_blank">code</a> clean and easily understandable, readble. Hope you will love it.</p>
                    <p class="decription-text text-justify"><a href="Approach-2">Second Approach</a> is about the image manipulation. Nothing much could have been there to do so I just rotated the image. But it will be fun to look at the <a href="https://github.com/NavneetaShrivastava/ChessBoard/blob/master/resources/views/board/Approach-2.blade.php"  target="_blank">code</a></p>
                    <p class="decription-text text-justify"><a href="Approach-1">First Approach</a> is frankly nothing but an ease of solving a very complex looking issue. If we divide the problems into two parts white and black then it will be jusst two images to load on one condition. Feel free to browse the <a href="https://github.com/NavneetaShrivastava/ChessBoard/blob/master/resources/views/board/Approach-1.blade.php" target="_blank">code</a> for it too.</p>
